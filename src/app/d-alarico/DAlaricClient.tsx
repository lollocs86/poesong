...
const dAlarico: Track = {
  id: 'd-alarico',
  title: "D'Alarico",
  artist: 'Poesong',
  duration: 240,
  audioUrl: '/audio/d-alarico.mp3',
  lyricsUrl: '/lyrics/d-alarico.ttml',
};

export function DAlaricClient() {
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="mb-8">
              <ol className="flex items-center space-x-2 text-sm text-white/60">
                ...
                <li>/</li>
                <li className="text-white">D&apos;Alarico</li>
              </ol>
            </nav>
              ...
              <div className="relative p-6 md:p-8 bg-gradient-to-b from-violet-900/50 to-transparent">
                <div className="flex flex-col md:flex-row items-center md:items-end gap-6">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold text-white mt-2">{dAlarico.title}</h1>
                    <p className="text-lg text-white/80 mt-2">{dAlarico.artist}</p>
            ...
            <div className="mt-12 text-center">
              <p className="text-white/70 max-w-2xl mx-auto leading-relaxed">
                Un brano che racconta di una traversata del fiume in una tempesta di pioggia torrenziale,
                tra il Crati e il Busento. Un viaggio tra paura, coraggio e la forza della natura.
              </p>
            </div>
          </div>
        </section>
