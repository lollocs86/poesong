      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-white/90 leading-relaxed mb-12">
            Dove le parole della cronaca si fermano, assordate dal frastuono e accecate dalla polvere, inizia il nostro canto. Queste non sono solo poesie; sono i sussurri raccolti tra le macerie, le ninne nanne mai finite, le preghiere laiche levate al cielo di Gaza. Le abbiamo vestite di musica non per coprire il dolore, ma per permettergli di viaggiare oltre i confini del filo spinato e dell&apos;indifferenza. Ogni nota è un passo tra le rovine, ogni verso un tentativo di restituire un nome e una storia ai silenzi. Questo è un requiem per ciò che è stato perso e un inno alla vita che, ostinatamente, resiste.
          </p>
          <Link
            href="/gazaladra"
